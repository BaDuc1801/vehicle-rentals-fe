        ...
        <div className='bg-[#f2f4f7] h-[calc(100vh-50px)] flex justify-center items-center'>
            ...
            >
                ...
                <Row gutter={[16, 24]}>
                    ...
                    <Col span={12}>
                        <Form.Item label="Nhiên liệu" name="fuel" rules={[{ required: true, message: 'Không được để trống' }]}>
                            <Select
                                options={[
                ...
                <Row gutter={[16, 24]}>
                    ...
                    <Col span={12}>
                        <Form.Item label="Số ghế" name="seats" rules={[{ required: true, message: 'Không được để trống' }]}>
                            <Select
                                options={[
                ...
                <Row gutter={[16, 24]}>
                    ...
                    <Col span={12}>
                        <Form.Item label="Hiệu suất nhiên liệu" name="fuelEfficiency" rules={[{ required: true, message: 'Không được để trống' }]}>
                            <Input type="number" />
                        </Form.Item>
                    </Col>
                </Row>
